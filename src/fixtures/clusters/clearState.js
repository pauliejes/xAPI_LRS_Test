...
clearState = {
    typical: function () {
        var activityId = "http://tincanapi.com/conformancetest/uniqueActivityId/" + factory.make("good UUID"),
            obj = {
                ...
                main: factory.make("typical clearState"),
                verify: factory.make("typical retrieveStateIds")
            };
        ...
        obj.verify.params.activityId = activityId;
    ...
    registered: function () {
        ...
        obj.main.params.activityId = activityId;
        obj.verify.params.registration = reg;
        obj.verify.params.activityId = activityId;
...
factory.register("clearStateCluster", clearState);